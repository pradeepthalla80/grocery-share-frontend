          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700">
                By accessing and using BaskMate, you accept and agree to be bound by the terms and conditions of this agreement. If you do not agree to these terms, please do not use our platform.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700">
                BaskMate is a peer-to-peer platform that connects users who want to share surplus grocery items. The platform facilitates listing items, searching for available groceries, and connecting buyers and sellers.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700">
                Users who list items for sale or donation are solely responsible for the accuracy of their listings, including descriptions, images, expiration dates, and pickup information. BaskMate does not verify the quality or safety of listed items.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700">
                Your privacy is important to us. We collect and process personal information in accordance with our Privacy Policy. By using BaskMate, you consent to the collection and use of your data as described.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-700">
                BaskMate is provided "as is" without warranties of any kind. We are not liable for any damages resulting from your use of the platform, including but not limited to health issues from consumed items, theft, fraud, or disputes between users.
              </p>
            </section>
