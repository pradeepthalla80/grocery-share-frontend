...
class _ItemsScreenState extends State<ItemsScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<LocationProvider, ItemsProvider, AuthProvider>(
        builder: (context, locationProvider, itemsProvider, authProvider, _) {
          ...
          final showStoreBanner = authProvider.isAuthenticated && !authProvider.isStoreOwner;
